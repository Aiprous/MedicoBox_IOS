...
class SignUpModelClass: NSObject {
    ...
    var signupModel_Dict = NSDictionary()
    var dob = String()
    ...
    func loadSignUpData(){
        ...
        group_id = self.signupModel_Dict["group_id"] as? Int ?? 0
        id = self.signupModel_Dict["id"] as? Int ?? 0
        store_id = self.signupModel_Dict["store_id"] as? Int ?? 0
        website_id = self.signupModel_Dict["website_id"] as? Int ?? 0
        store_id = self.signupModel_Dict["store_id"] as? Int ?? 0
        disable_auto_group_change = self.signupModel_Dict["disable_auto_group_change"] as? Int ?? 0
